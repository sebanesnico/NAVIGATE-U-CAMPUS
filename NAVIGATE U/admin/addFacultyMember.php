...
<link rel="stylesheet" href="assets/css/addFacultyMember.css">
        ...
        <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="facultyname" class="form-control" id="facultyname" placeholder="Enter faculty name">
                </div>
                <div class="form-group">
